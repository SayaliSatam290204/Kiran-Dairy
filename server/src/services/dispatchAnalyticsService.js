  ...
  getComprehensiveAnalytics: async (startDate, endDate) => {
    try {
      ...
      if (startDate || endDate) {
        ...
        if (endDate) filters.dispatchDate.$lte = new Date(endDate);
      }
      ...
      const [
        ...
        this.getFrequencyByShop(filters),
        this.getStatusSummary(filters),
        this.getBatchStats(filters),
        this.getDeliveryTimeStats(filters),
        this.getTopDispatchingShops(10, filters)
      ]);
